...
async def RANDOMreact(event):
    if event.fwd_from:
        return
    input_str = event.pattern_match.group(1)
    if input_str in "تبلیغ":
        emoticons = [
            "تیم برنامه نویسی Mr Self"
        ]
...
#  YouTube : Mr Self 
#          Mr  self
#  YouTube : Mr Self             حمایت فراموش نشه
# فوشو اینا نمیزارم من با شخصیتم ولی اگه دوسداری کیرمو بخوری  راحت باش و این چارتا متنو پاک کن نفس ♡
import html
from telethon.tl.functions.photos import GetUserPhotosRequest
from telethon.tl.functions.users import GetFullUserRequest
from telethon.tl.types import MessageEntityMentionName
...
کپی برداری از اکلنت شخص بر روی اکانت شما
-....-....-....-....-
.weather city

 اطلاع از آب و هوای شهر
-....-....-....-....-
.edit 
...
رندوم ی متن تبلیغ ست شده رو میفرسته
-....-....-....-....-
💠Mr  self''')
